...
import net.hazen.hazennstuff.entity.armor.ArbitriumRobesArmorModel;
...
public class ArbitriumRobesArmorRenderer extends GeoArmorRenderer<ArbitriumRobesArmorItem> {
    public ArbitriumRobesArmorRenderer() {
        super(new ArbitriumRobesArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(ArbitriumRobesArmorRenderer.this));
    }
