...
import net.hazen.hazennstuff.item.armor.animators.*;
...
public class FleshMassArmorRenderer extends AzArmorRenderer {
    private static final ResourceLocation GEO = ResourceLocation.fromNamespaceAndPath(
            HazenNStuff.MOD_ID,
            "geo/flesh_mass_armor.geo.json"
    );

    private static final ResourceLocation TEX = ResourceLocation.fromNamespaceAndPath(
            HazenNStuff.MOD_ID,
            "textures/models/armor/flesh_mass_armor.png"
    );
