...
import net.hazen.hazennstuff.entity.armor.FireblossomBattlemageCrownedArmorModel;
import net.hazen.hazennstuff.entity.armor.FireblossomBattlemageHelmetArmorModel;
import net.hazen.hazennstuff.item.armor.EnderDragonArmorItem;
import net.hazen.hazennstuff.item.armor.FireblossomBattlemageCrownedArmorItem;
import net.hazen.hazennstuff.item.armor.FireblossomBattlemageHelmetArmorItem;
import net.minecraft.client.model.HumanoidModel;
import net.minecraft.client.model.geom.ModelPart;
import net.minecraft.world.entity.EquipmentSlot;

public class FireblossomBattlemageCrownedArmorRenderer extends GeoArmorRenderer<FireblossomBattlemageCrownedArmorItem> {
    public FireblossomBattlemageCrownedArmorRenderer() {
        super(new FireblossomBattlemageCrownedArmorModel());
        addRenderLayer(new AutoGlowingGeoLayer<>(FireblossomBattlemageCrownedArmorRenderer.this));
    }
