...
import net.hazen.hazennstuff.item.armor.animators.BasicArmorAnimator;
import net.hazen.hazennstuff.item.armor.animators.CryogenicRulerAnimator;
import net.hazen.hazennstuff.item.armor.animators.EnderDragonAnimator;
import net.hazen.hazennstuff.item.armor.animators.FireblossomAnimator;
...
public class FireblossomBattlemageCrownedArmorRenderer extends AzArmorRenderer {
    ...
    private static final ResourceLocation TEX = ResourceLocation.fromNamespaceAndPath(
            HazenNStuff.MOD_ID,
            "textures/models/armor/fireblossom_battlemage_crowned_armor.png"
    );
