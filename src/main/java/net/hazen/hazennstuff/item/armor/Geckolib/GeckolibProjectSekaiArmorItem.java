...
public class GeckolibProjectSekaiArmorItem extends ImbuableGeckolibHnSArmorItem {
    public GeckolibProjectSekaiArmorItem(Type type, Properties settings) {
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new GenericCustomArmorRenderer<>(new GeckolibProjectSekaiArmorModel());
    }
}