...
import net.hazen.hazennstuff.entity.render.armor.SoulFlameArmorRenderer;
...
public class SoulFlameArmorItem extends ImbuableHnSArmorItem implements GeoAnimatable, GeoItem {
    public SoulFlameArmorItem(ArmorItem.Type type, Properties settings) {
    ...
    public void createRenderer(Consumer<RenderProvider> consumer) {
        consumer.accept(new RenderProvider() {
            private SoulFlameArmorRenderer renderer;

            @Override
            public HumanoidModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<LivingEntity> original) {
                if (renderer == null)
                {
                    renderer = new SoulFlameArmorRenderer();
                }
